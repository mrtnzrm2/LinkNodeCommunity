...
if __name__ == "__main__":
    ...
    fig = plt.figure(1, figsize=(4, 3.3)) # 3.54331
    ...
    axb = fig.add_subplot(gs[0:1, 0:1])
    axb.minorticks_on()

    # axb.text(
    #   0.0, 1.0, "a", fontsize=20, transform=axb.transAxes,
    ...
    ax_histy = fig.add_subplot(gs[0:1, 1:2], sharey =axb)
