...
# Load plots ----
from network_impAnalysis import network_cover_plot
...
if __name__ == "__main__":
    ...
    network_cover_plot(NET, H, ax, cmap=color_palette, ang=45)
    ...
    plt.savefig(
      "../Publication/Nature Neuroscience/ExtendedFigures/ImpAnalysis/net40i.svg", bbox_inches='tight'
    )
    plt.savefig(
      "../Publication/Nature Neuroscience/ExtendedFigures/ImpAnalysis/net40i.pdf", bbox_inches='tight'
    ) 