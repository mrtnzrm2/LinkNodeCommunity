...
# Load plots ----
from network_29Analysis import network_cover_plot
...
if __name__ == "__main__":
    ...
    plt.savefig(
      "../Publication/Nature Neuroscience/ExtendedFigures/29Analysis/net29.svg", bbox_inches='tight'
    )
    plt.savefig(
      "../Publication/Nature Neuroscience/ExtendedFigures/29Analysis/net29.pdf", bbox_inches='tight'
    ) 