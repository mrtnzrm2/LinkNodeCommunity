    ...
    **In the future, there will be another class to run the link community algorithm
    ...
    Parameters:
        ...
        nlog10: bool.
          ...
          It also adds a "_l10" suffix to the plot directory.
        ...
        lookup: bool.
          ...
          computing the similarities. They do not modify the topology of the network.
        ...
        cut: bool.
          ...
          getting results very different from full analysis.
