...
class base:
  def __init__(self, linkage, **kwargs) -> None:
    ...
    self.csv_path = "../CSV/MAC/47d106_230605/"
    self.distance_path = f"../CSV/MAC/47d106_230605/{self.distance}/"
    # Labels and regions ----
...
class MAC47(base):
  ...
  def get_structure(self):
    # Get structure ----
    file = pd.read_csv(f"{self.csv_path}/CountMatrix_Averaged_47areas_SBRI_230605-1.csv", index_col=0)
    ## Areas to index
