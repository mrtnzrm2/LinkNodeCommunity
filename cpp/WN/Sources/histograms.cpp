...
int log_histogram(deque<type> &c, int number_of_bins) {		// c is the set od data, min is the lower bound, max is the upper one
...
template <typename type>
int histogram (vector <type> &c, int number_of_bins, double b1, double b2) {		
...
template <typename type>
int not_norm_histogram_correlated (deque<type> &c, deque<type> &d, int number_of_bins, double b1, double b2) {		
...
template <typename type>
int histogram (deque <type> &c, int number_of_bins, double b1, double b2) {		
...
template <typename type>
int not_norm_histogram (vector<type> &c, int number_of_bins, double b1, double b2) {		
...
template <typename type>
int not_norm_histogram (deque<type> &c, int number_of_bins, double b1, double b2) {		
...
int int_histogram (vector <int> &c) {
